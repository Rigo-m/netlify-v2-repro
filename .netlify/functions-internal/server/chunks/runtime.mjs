...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/matteorigoni/Projects/nitro-netlify-v2/.data/kv"}));
...
const _lazy_5p9HkE = () => import('./routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_5p9HkE, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_5p9HkE, lazy: true, middleware: false, method: undefined }
];
...
export { send as a, setResponseStatus as b, setResponseHeaders as c, useRuntimeConfig as d, eventHandler as e, getQuery as f, getResponseStatus as g, createError$1 as h, getRouteRules as i, joinRelativeURL as j, getResponseStatusText as k, sanitizeStatusCode as l, createHooks as m, createRouter$1 as n, handler as o, setResponseHeader as s, toRouteMatcher as t, useNitroApp as u };
