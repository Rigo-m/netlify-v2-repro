import { version, ref, watchEffect, watch, getCurrentInstance, unref, inject, useSSRContext, createApp, effectScope, reactive, getCurrentScope, hasInjectionContext, mergeProps, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, defineAsyncComponent, computed, defineComponent, h, isReadonly, isRef, isShallow, isReactive, toRaw } from 'vue';
...
const mr = Symbol.toStringTag, yi = n((i) => typeof i == "object" && typeof i.append == "function" && typeof i.delete == "function" && typeof i.get == "function" && typeof i.getAll == "function" && typeof i.has == "function" && typeof i.set == "function" && typeof i.sort == "function" && i[mr] === "URLSearchParams", "isURLSearchParameters"), yr = n((i) => i && typeof i == "object" && typeof i.arrayBuffer == "function" && typeof i.type == "string" && typeof i.stream == "function" && typeof i.constructor == "function" && /^(Blob|File)$/.test(i[mr]), "isBlob"), Qs = n((i) => typeof i == "object" && (i[mr] === "AbortSignal" || i[mr] === "EventTarget"), "isAbortSignal"), Ys = n((i, o2) => {
  ...
  async formData() {
    ...
    const { toFormData: a2 } = await import('./multipart-parser-BaDqkqCr.mjs');
...
function createNuxtApp(options) {
  ...
  const nuxtApp = {
    ...
    versions: {
      get nuxt() {
        return "3.12.0-28587627.2d1ab61b";
      },
      get vue() {
...
const unhead_XeIQZ7NDrO = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const router_I2l0hwc78H = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:router",
  enforce: "pre",
  setup(nuxtApp) {
...
const revive_payload_server_8VaYqdxidi = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  unhead_XeIQZ7NDrO,
  router_I2l0hwc78H,
  revive_payload_server_8VaYqdxidi,
...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt-nightly@3.12.0-28587627.2d1ab61b_@opentelemetry+api@1.8.0_@unocss+reset@0.60.0_floating-_rjznq5s4zx53umhecx4do7ctdi/node_modules/nuxt-nightly/dist/app/components/welcome.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-a3be6a3e"]]);
const _sfc_main$2 = {};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-D-YP-yZ7.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-BuCgKM0j.mjs').then((r) => r.default || r));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt-nightly@3.12.0-28587627.2d1ab61b_@opentelemetry+api@1.8.0_@unocss+reset@0.60.0_floating-_rjznq5s4zx53umhecx4do7ctdi/node_modules/nuxt-nightly/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt-nightly@3.12.0-28587627.2d1ab61b_@opentelemetry+api@1.8.0_@unocss+reset@0.60.0_floating-_rjznq5s4zx53umhecx4do7ctdi/node_modules/nuxt-nightly/dist/app/components/nuxt-root.vue");
...
export { On as O, _export_sfc as _, navigateTo as a, useRuntimeConfig as b, withoutTrailingSlash as c, useHead as d, entry$1 as default, br as e, hasProtocol as h, joinURL as j, nuxtLinkDefaults as n, parseQuery as p, useRouter as u, withTrailingSlash as w };
